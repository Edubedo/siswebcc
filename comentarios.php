...
?>
    ...
    <div class="mb-5 container-fluid page-header position-relative">
        ...
        <div class="pt-0 d-flex flex-column align-items-center justify-content-center pt-lg-5 pt-2" style="min-height: 200px">            <h1 class="mt-0 mb-3 text-white display-4 mt-lg-5 text-uppercase">Comentarios</h1>
