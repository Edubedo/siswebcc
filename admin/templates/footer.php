...
<div class="px-0 text-white container-fluid footer position-relative">
    <div class="pt-5 mx-0 mt-4 row px-sm-3 px-lg-5">
        <div class=" col-lg-4"> <!-- Cambiado de col-lg-3 a col-lg-4 -->
            <h4 class="text-white text-uppercase" style="letter-spacing: 3px;">Datos de Contacto</h4>
        ...
        <div class=" col-lg-4"> <!-- Cambiado de col-lg-3 a col-lg-4 -->
            <h4 class="text-white text-uppercase" style="letter-spacing: 3px;">Redes sociales</h4>
            <div class="w-100">
    ...
    <div class="text-center text-white container-fluid border-top px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
