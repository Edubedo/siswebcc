<div class="p-0 container-fluid nav-ba" style="background-color: #3F9E5F;">
        ...
        <a href="http://localhost/siswebcc/admin/" class="m-0 navbar-brand px-lg-4">
    <h1 class="m-0 text-white display-4 text-uppercase">Administrador</h1>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="p-4 ml-auto navbar-nav">
                    <a href="http://localhost/siswebcc/admin/secciones/servicios" class="nav-item nav-link ">Servicios</a>
                    <a href="http://localhost/siswebcc/admin/secciones/equipo" class="nav-item nav-link">Equipo</a>
                    <a href="http://localhost/siswebcc/admin/secciones/prestamos" class="nav-item nav-link">Prestamos</a>
                    <a href="http://localhost/siswebcc/admin/secciones/usuarios" class="nav-item nav-link">Usuarios</a>
